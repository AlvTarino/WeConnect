...
class wcUser:
    ...
    def create_business(self, name, *business_description):
        '''
        creates business and allows users to add a description to the business
        '''
    ...
    def read_business(self, name):
        '''
        Returns business_description from a specified business
        '''
    ...
    def update_business_description(self, business_name, description_heading, new_description):
        '''
        creates new business-description
        '''
        if business_name in self.business.keys():
    ...
    def add_business_description(self, business_name, *business_description):
        '''
        adds on the already existing business_description
        '''
        business_description = list(business_description)
        if business_name in self.business.keys():
    ...
    def delete_business_description(self, business_name, description):
        '''
    deletes  the business description
        '''
